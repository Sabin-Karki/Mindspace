    ...
    <div className="min-h-[calc(100vh-60px)] flex">
      ...
      <div className="hidden lg:flex lg:w-[45%] bg-bg-sec relative overflow-hidden">
        ...
        <div className="absolute inset-0">
          ...
          <div className="absolute bottom-32 right-10 w-80 h-80 bg-indigo-500/10 rounded-full blur-3xl" />
        ...
        <div className="relative z-10 flex flex-col justify-center px-16 py-12">
          <div className="max-w-sm">
            ...
            <p className="text-text-sec text-base leading-relaxed mb-12">
              Continue your learning journey. Your notes, flashcards, and AI conversations are waiting for you.
            </p>
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3 text-text-sec">
                ...
                <span className="text-sm">Instant access to your study materials</span>
              </div>
              <div className="flex items-center gap-3 text-text-sec">
                <div className="w-1.5 h-1.5 bg-blue-500 rounded-full" />
                <span className="text-sm">Pick up where you left off</span>
              </div>
              <div className="flex items-center gap-3 text-text-sec">
                <div className="w-1.5 h-1.5 bg-blue-500 rounded-full" />
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12 bg-bg-pri">
        <div className="w-full max-w-sm">
          {/* Header */}
          <div className="mb-8">
            <h2 className="text-2xl font-semibold text-text-pri mb-2">Sign in</h2>
